...
class educationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required'=>'Company Name must fill',
                'info1.required'=>'Faculty must fill',
                'tgl_mulai.required'=>'Start Date must fill',
            ]
        );
        ...
        return redirect()->route('education.index')->with('success','Successfully add data');
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required'=>'Company Place must fill',
                'info1.required'=>'Faculty must fill',
                'tgl_mulai.required'=>'Start Date must fill',
        ...
        return redirect()->route('education.index')->with('success','Successfully update data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('education.index')->with('success','Successfully delete data');
    }
}
