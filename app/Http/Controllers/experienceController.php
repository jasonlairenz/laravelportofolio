...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'judul.required'=>'Role must fill',
                'info1.required'=>'Company Name must fill',
                'tgl_mulai.required'=>'Start Date must fill',
                'isi.required'=>'Description must fill',
            ]
        );
        ...
        return redirect()->route('experience.index')->with('success','Successfully add data');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('experience.index')->with('success','Successfully update data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('experience.index')->with('success','Successfully delete data');
    }
}
