    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2"
                    src="{{ asset('foto') . '/' . getMeta_value('_foto') }}" alt="..." /></span>
        </a>
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    {{ getMeta_value('_kota') }} .
                    {{ getMeta_value('_provinsi') }} .
                    {{ getMeta_value('_nohp') }} .
                    <a href="{{ getMeta_value('_email') }}">{{ getMeta_value('_email') }} . </a>
                </div>
                <div class="lead mb-5">{!! $about->isi !!}</div>
                <div class="social-icons">
                    <a class="social-icon" href="{{ getMeta_value('_linkedin') }}"><i
                            class="fab fa-linkedin-in"></i></a>
                    <a class="social-icon" href="{{ getMeta_value('_github') }}"><i class="fab fa-github"></i></a>
                    <a class="social-icon" href="{{ getMeta_value('_twitter') }}"><i class="fab fa-twitter"></i></a>
                    <a class="social-icon" href="{{ getMeta_value('_facebook') }}"><i
        ...
        <section class="resume-section" id="skills">
            <div class="resume-section-content">
                ...
                <ul class="list-inline dev-icons">
                    @foreach (explode(', ', getMeta_value('_language')) as $item)
